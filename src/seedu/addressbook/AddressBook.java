...
public class AddressBook {
    ...
    */
     ...
     *
     * @param targetInModel the actual person inside the address book (exactPerson == the person to delete in the full list)
    ...
    private static String getNameFromPerson(HashMap<PersonProperty,String> person) {
        String personName = person.get(PersonProperty.NAME);
		return personName;
    }
    //person.get(PERSON...)
    ...
    private static String getPhoneFromPerson(HashMap<PersonProperty,String> person) {
        String personPhone = person.get(PersonProperty.PHONE);
		return personPhone;
    }
    //person.get(PERSON...NUMBER)

    /**
     * Returns given person's email
     *
     * @param personToAdd whose email you want
     */
    private static String getEmailFromPerson(HashMap<PersonProperty, String> person) {
        String personEmail = person.get(PersonProperty.EMAIL);
		return personEmail;
    }
    ...
    private static String extractNameFromPersonString(String encoded) {
        ...
        String nameFromPersonString = encoded.substring(0, indexOfFirstPrefix).trim();
		return nameFromPersonString;
    }
    ...
    private static String extractPhoneFromPersonString(String encoded) {
        ...
        if (indexOfPhonePrefix > indexOfEmailPrefix) {
            String phoneFromPersonString = removePrefixSign(encoded.substring(indexOfPhonePrefix, encoded.length()).trim(),
                    PERSON_DATA_PREFIX_PHONE);
			return phoneFromPersonString;

        // phone is middle arg, target is from own prefix to next prefix
        } else {
            String phoneFromPersonString = removePrefixSign(
    ...
    private static String extractEmailFromPersonString(String encoded) {
        ...
        if (indexOfEmailPrefix > indexOfPhonePrefix) {
            String emailFromPersonString = removePrefixSign(encoded.substring(indexOfEmailPrefix, encoded.length()).trim(),
                    PERSON_DATA_PREFIX_EMAIL);
			return emailFromPersonString;

        // email is middle arg, target is from own prefix to next prefix
        } else {
            String emailFromPersonString = removePrefixSign(
    ...
    private static String getUsageInfoForAllCommands() {
        String infoForAllCommands = getUsageInfoForAddCommand() + LS
    ...
    private static String getUsageInfoForAddCommand() {
        String infoForAddCommnads = String.format(MESSAGE_COMMAND_HELP, COMMAND_ADD_WORD, COMMAND_ADD_DESC) + LS
